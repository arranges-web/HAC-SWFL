...
import { ArrowRight, CreditCard, ShieldCheck, ThermometerSnowflake, Zap } from "lucide-react";
        ...
        >
          ...
          <div className="flex flex-wrap gap-3 sm:gap-4 pt-4">
            <a href="#contact" className="inline-flex">
              <Button size="lg" className="bg-secondary text-secondary-foreground hover:bg-secondary/90 font-bold h-14 px-7 text-base sm:text-lg shadow-[0_0_20px_rgba(49,232,67,0.4)] hover:shadow-[0_0_30px_rgba(49,232,67,0.6)] transition-all group">
                Instant A/C Quote
                <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
              </Button>
            </a>
            <a href="#contact" className="inline-flex">
              <Button size="lg" variant="outline" className="bg-white/5 border-white/20 text-white hover:bg-white/10 h-14 px-7 font-bold text-base sm:text-lg backdrop-blur-sm">
                Free Second Opinion
              </Button>
            </a>
            <a href="#financing" className="inline-flex">
              <Button size="lg" className="bg-[#F4951F] text-white hover:bg-[#F4951F]/90 font-bold h-14 px-7 text-base sm:text-lg shadow-[0_0_20px_rgba(244,149,31,0.4)] hover:shadow-[0_0_30px_rgba(244,149,31,0.6)] transition-all group">
